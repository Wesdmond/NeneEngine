...
void CGLAB::BuildTerrainRootSignature()
{
	...
	heightRange.Init(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 1, 0); // t0

	CD3DX12_DESCRIPTOR_RANGE diffuseRange;
	diffuseRange.Init(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 1, 1); // t0
...
void CGLAB::BuildPSOs()
{
	...
	gbPsoDesc.DSVFormat = mDepthStencilFormat;
